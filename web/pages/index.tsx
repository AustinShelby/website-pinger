                ...
                return (
                  ...
                  >
                    <div className="relative">
                      <div className="absolute left-0 bottom-0 bg-gray-900 border border-gray-700 shadow-md px-4 py-2">
                        <div className="flex items-center">
                          {result && (
                            <div className="relative h-2 w-2 mr-4">
                              <div
                                className={`h-2 w-2 absolute animate-ping ${
                                  result.results.total < 800
                                    ? "bg-green-500"
                                    : result.results.total < 1200
                                    ? "bg-yellow-500"
                                    : "bg-red-500"
                                } rounded full`}
                              ></div>
                      ...
                      <div className="absolute h-4 w-4 rotate-45 bg-gray-900 -bottom-2 left-1 border-r border-b border-gray-700"></div>
                    </div>
                  </div>
                );
              })}
